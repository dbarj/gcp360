...
-----------------------------------------
@@&&fc_json_loader. 'GCP_COMPUTE_ACCELERATOR_TYPES'
@@&&fc_json_loader. 'GCP_COMPUTE_ADDRESSES'
@@&&fc_json_loader. 'GCP_COMPUTE_BACKEND_BUCKETS'
@@&&fc_json_loader. 'GCP_COMPUTE_BACKEND_SERVICES'
@@&&fc_json_loader. 'GCP_COMPUTE_COMMITMENTS'
@@&&fc_json_loader. 'GCP_COMPUTE_DISK_TYPES'
@@&&fc_json_loader. 'GCP_COMPUTE_DISKS'
@@&&fc_json_loader. 'GCP_COMPUTE_EXTERNAL_VPN_GATEWAYS'
@@&&fc_json_loader. 'GCP_COMPUTE_FIREWALL_RULES'
@@&&fc_json_loader. 'GCP_COMPUTE_FORWARDING_RULES'
@@&&fc_json_loader. 'GCP_COMPUTE_HEALTH_CHECKS'
@@&&fc_json_loader. 'GCP_COMPUTE_HTTP_HEALTH_CHECKS'
@@&&fc_json_loader. 'GCP_COMPUTE_HTTPS_HEALTH_CHECKS'
@@&&fc_json_loader. 'GCP_COMPUTE_IMAGES'
@@&&fc_json_loader. 'GCP_COMPUTE_INSTANCE_GROUPS_MANAGED_INSTANCE_CONFIGS'
@@&&fc_json_loader. 'GCP_COMPUTE_INSTANCE_GROUPS_MANAGED'
@@&&fc_json_loader. 'GCP_COMPUTE_INSTANCE_GROUPS_UNMANAGED'
@@&&fc_json_loader. 'GCP_COMPUTE_INSTANCE_GROUPS'
@@&&fc_json_loader. 'GCP_COMPUTE_INSTANCE_TEMPLATES'
@@&&fc_json_loader. 'GCP_COMPUTE_INSTANCES'
@@&&fc_json_loader. 'GCP_COMPUTE_INTERCONNECTS_ATTACHMENTS'
@@&&fc_json_loader. 'GCP_COMPUTE_INTERCONNECTS_LOCATIONS'
@@&&fc_json_loader. 'GCP_COMPUTE_INTERCONNECTS'
@@&&fc_json_loader. 'GCP_COMPUTE_MACHINE_TYPES'
@@&&fc_json_loader. 'GCP_COMPUTE_NETWORK_ENDPOINT_GROUPS'
@@&&fc_json_loader. 'GCP_COMPUTE_NETWORKS_PEERINGS'
@@&&fc_json_loader. 'GCP_COMPUTE_NETWORKS_SUBNETS'
@@&&fc_json_loader. 'GCP_COMPUTE_NETWORKS_VPC_ACCESS_CONNECTORS'
@@&&fc_json_loader. 'GCP_COMPUTE_NETWORKS_VPC_ACCESS_LOCATIONS'
@@&&fc_json_loader. 'GCP_COMPUTE_NETWORKS'
@@&&fc_json_loader. 'GCP_COMPUTE_OS_CONFIG_PATCH_DEPLOYMENTS'
@@&&fc_json_loader. 'GCP_COMPUTE_OS_CONFIG_PATCH_JOBS'
@@&&fc_json_loader. 'GCP_COMPUTE_OS_LOGIN_SSH_KEYS'
@@&&fc_json_loader. 'GCP_COMPUTE_PACKET_MIRRORINGS'
@@&&fc_json_loader. 'GCP_COMPUTE_PROJECT_INFO'
@@&&fc_json_loader. 'GCP_COMPUTE_REGIONS'
@@&&fc_json_loader. 'GCP_COMPUTE_RESERVATIONS'
@@&&fc_json_loader. 'GCP_COMPUTE_RESOURCE_POLICIES'
@@&&fc_json_loader. 'GCP_COMPUTE_ROUTERS_NATS'
@@&&fc_json_loader. 'GCP_COMPUTE_ROUTERS'
@@&&fc_json_loader. 'GCP_COMPUTE_ROUTES'
@@&&fc_json_loader. 'GCP_COMPUTE_SECURITY_POLICIES'
@@&&fc_json_loader. 'GCP_COMPUTE_SHARED_VPC_ASSOCIATED_PROJECTS'
@@&&fc_json_loader. 'GCP_COMPUTE_SNAPSHOTS'
@@&&fc_json_loader. 'GCP_COMPUTE_SOLE_TENANCY_NODE_GROUPS'
@@&&fc_json_loader. 'GCP_COMPUTE_SOLE_TENANCY_NODE_TEMPLATES'
@@&&fc_json_loader. 'GCP_COMPUTE_SOLE_TENANCY_NODE_TYPES'
@@&&fc_json_loader. 'GCP_COMPUTE_SSL_CERTIFICATES'
@@&&fc_json_loader. 'GCP_COMPUTE_SSL_POLICIES'
@@&&fc_json_loader. 'GCP_COMPUTE_TARGET_GRPC_PROXIES'
@@&&fc_json_loader. 'GCP_COMPUTE_TARGET_HTTP_PROXIES'
@@&&fc_json_loader. 'GCP_COMPUTE_TARGET_HTTPS_PROXIES'
@@&&fc_json_loader. 'GCP_COMPUTE_TARGET_INSTANCES'
@@&&fc_json_loader. 'GCP_COMPUTE_TARGET_POOLS'
@@&&fc_json_loader. 'GCP_COMPUTE_TARGET_SSL_PROXIES'
@@&&fc_json_loader. 'GCP_COMPUTE_TARGET_TCP_PROXIES'
@@&&fc_json_loader. 'GCP_COMPUTE_TARGET_VPN_GATEWAYS'
@@&&fc_json_loader. 'GCP_COMPUTE_TPUS_ACCELERATOR_TYPES'
@@&&fc_json_loader. 'GCP_COMPUTE_TPUS_LOCATIONS'
@@&&fc_json_loader. 'GCP_COMPUTE_TPUS_VERSIONS'
@@&&fc_json_loader. 'GCP_COMPUTE_TPUS'
@@&&fc_json_loader. 'GCP_COMPUTE_URL_MAPS'
@@&&fc_json_loader. 'GCP_COMPUTE_VPN_GATEWAYS'
@@&&fc_json_loader. 'GCP_COMPUTE_VPN_TUNNELS'
@@&&fc_json_loader. 'GCP_COMPUTE_ZONES'
-----------------------------------------

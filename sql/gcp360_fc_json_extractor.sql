...
-- HOS unzip -o -d &&moat369_sw_output_fdr. &&gcp360_json_zip.
...
-- HOS cd &&moat369_sw_folder.; echo "DEF gcp360_export_file=\"$(ls -1 gcp_json_export_*.zip)\"" > &&step_json_file_driver.
-- HOS cd &&moat369_sw_folder.; ls -1 gcp_json_export_* | xargs unzip -d &&moat369_sw_output_fdr.
-- 
-- 
-- 
